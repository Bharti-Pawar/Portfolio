        ...
        <div className="glass p-6 transition-transform duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:ring-1 hover:ring-white/10">
          ...
          <div className="mt-6 pt-4 border-t border-white/10">
            ...
            <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
              {[
                { category: 'Frontend Development', skills: 'React, Nextjs, JavaScript, Tailwind CSS, Shadcn UI, Zustand and Zod' },
                // { category: 'Backend Development', skills: 'Django, FastAPI, Python' },
                { category: 'Backend Development', skills: 'Django, Python' },
                { category: 'Database Management', skills: 'SQL, Data Optimization' },
                { category: 'Cloud & DevOps', skills: 'Docker, Cloud Infrastructure, Deployment' }
              ].map((category) => (
