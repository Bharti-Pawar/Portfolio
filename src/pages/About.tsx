      ...
      <motion.div className="mt-6" variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }}>
        <div className="glass p-6 transition-transform duration-300 ease-out hover:-translate-y-1 hover:shadow-xl hover:ring-1 hover:ring-white/10">
          ...
          <div className="space-y-4">
            ...
            Experienced software engineer with 1.5+ years in React, Next.js, Django and PostgreSQL.
            Proven ability to deliver scalable web applications,real-time systems, and automation workflows in production environments and collaborating with cross-functional teams.
            </p>
